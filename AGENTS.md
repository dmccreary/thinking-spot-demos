# AI Agent Instructions — Thinking Spot Demos

Welcome, Agent. You have been asked to generate, edit, or validate content for
the **Thinking Spot Demos** intelligent textbook.
...
| | |
|---|---|
| Book title | Thinking Spot Demos |
| Published site | https://dmccreary.github.io/thinking-spot-demos/ |
| Repository | https://github.com/dmccreary/thinking-spot-demos |
...
- The published lesson URL is
  `https://dmccreary.github.io/thinking-spot-demos/sims/<sim-id>/`. Always
